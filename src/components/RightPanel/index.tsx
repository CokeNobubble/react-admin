...
const RightPanel: FC<Props> = forwardRef(({ slot }, ref): ReactElement => {
  ...
  return (
    <div ref={rightPanel} className="duration-300">
      ...
      ></div>
      <div
        className={`z-999 fixed top-0 max-w-300px wh-full bg-[var(--bg-color)] c-[var(--text-color)] duration-300 ${panelPos}`}
      >
        <Button
          onClick={togglePanel}
          className={`absolute z-999 left--32px top-200px`}
          ref={ref}
          type="primary"
          icon={
